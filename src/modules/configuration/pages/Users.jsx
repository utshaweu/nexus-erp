...
import { z } from 'zod'
import { Plus, Search, Shield, UserX, UserCheck, Users } from 'lucide-react'
import {
      ...
      {loading ? (
        ...
        <div className="space-y-4">
          <p className="text-xs text-slate-500 dark:text-slate-400">
            ...
            <span className="text-slate-500 font-semibold">— inherit from role</span>
          </p>
            ...
            <table className="w-full text-xs">
              ...
              <tbody className="divide-y divide-surface-200 dark:divide-surface-800/70">
                {installedModules.map(mod => (
                  <tr key={mod.id} className="hover:bg-surface-50 dark:hover:bg-surface-800/30 transition-colors">
                            ...
                            className={`w-7 h-7 rounded-md text-xs font-bold transition-all border ${
                              val === true
                                ...
                                : val === false
                                  ...
                                  : 'bg-surface-100 dark:bg-surface-800 text-slate-400 dark:text-slate-600 border-surface-200 dark:border-surface-700 hover:bg-surface-200 dark:hover:bg-surface-700'
                            }`}
                          >
                            {val === true ? '✓' : val === false ? '✗' : '—'}
                          </button>
